...
@JsonTypeName(FirebaseIdAlreadyUseErrorResponse.TYPE_NAME)
@Getter
@ToString(callSuper = true, exclude = "errorCodeSwaggerDocumentation")
@EqualsAndHashCode(callSuper = true)
public class FirebaseIdAlreadyUseErrorResponse extends ErrorResponse {
    protected static final String TYPE_NAME = "ALREADY_EXISTS";
    ...
    @Schema(description = "l'id firebase utilisé pour la création d'utilisateur ",example = "3ddezo4")
    private final String fireBaseId;

    @Builder
    @Jacksonized
    public FirebaseIdAlreadyUseErrorResponse(String uri, HttpStatus httpStatus, ErrorCode errorCode, String errorMessage, String fireBaseId) {
